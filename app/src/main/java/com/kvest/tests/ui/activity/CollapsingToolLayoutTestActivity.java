 ...
 */
public class CollapsingToolLayoutTestActivity extends AppCompatActivity {
    private static final int DATASET_SIZE = 100;
    private CoordinatorLayout coordinatorLayout;

    public static void start(Context context) {
        Intent intent = new Intent(context, CollapsingToolLayoutTestActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.collapsing_tool_layout_test_activity);
